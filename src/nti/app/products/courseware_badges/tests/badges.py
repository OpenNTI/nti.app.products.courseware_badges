...
def generate_db(database):
	...
	database.add_badge(name=u'Law and Justice',
					   image=u'http://janux.ou.edu/bages/tag_nextthought.com_2011-10_OU-HTML-CLC3403_LawAndJustice.course_completion_badge.png',
	...
	database.add_badge(name=u'Chemistry of Beer',
					   image=u'http://localhost:8082/hosted_badge_images/tag_nextthought.com_2011-10_OU-HTML-CHEM4970_Chemistry_of_Beer.course_completion_badge.png',
	...
	database.add_badge(name=u'Power and Elegance of Computational Thinking',
					   image=u'http://localhost:8082/hosted_badge_images/tag_nextthought.com_2011-10_OU-HTML-CS1300_Power_and_Elegance_of_Computational_Thinking.course_completion_badge.png',
	...
	database.add_badge(name=u'History of Science',
					   image=u'http://localhost:8082/hosted_badge_images/tag_nextthought.com_2011-10_OU-HTML-HSCI3013_History_of_Science.course_completion_badge.png',
	...
	database.add_badge(name=u'Hydraulic Fracturing',
					   image=u'http://localhost:8082/hosted_badge_images/tag_nextthought.com_2011-10_OU-HTML-GEOG3890_Hydraulic_Fracturing_and_Water_Resources.course_completion_badge.png',
