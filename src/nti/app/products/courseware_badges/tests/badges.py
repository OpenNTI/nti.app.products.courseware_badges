...
def generate_db(database):
    ...
    database.add_badge(name=u'Power and Elegance of Computational Thinking',
                       ...
                       issuer_id=issuer_id,
                       tags=u'programming,computers,control')
    ...
    database.add_badge(name=u'Hydraulic Fracturing',
                       ...
                       issuer_id=issuer_id,
                       tags=u'fracturing,hydraulic,water')

    database.add_person(email=u'sjohnson@nextthought.com',
                        nickname=u'sjohnson@nextthought.com',
                        website=u'http://www.nextthought.com/persons/sjohnson.htm',
                        bio=u'I am Steve')
